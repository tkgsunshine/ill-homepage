...
SUMMARY_MAPPING = {
    ...
    "042-hiring-vs-outsourcing-cost-comparison.html": "採用固定費を回避し開発外注でコストを抑える",
    "043-excel-to-web-system-dx-cost.html": "エクセル業務限界を安価な独自Webシステムで解消",
    ...
    "048-simple-rfp-writing-for-non-it-buyers.html": "IT知識ゼロから書けるRFP作成手順を解説する",
    "049-smb-ec-site-development-shopify-cost.html": "Shopifyを活用しEC開発費用を劇的に抑える",
    "050-c2c-sharing-matching-platform-development.html": "パッケージとAPIを駆使したマッチング開発",
    "051-custom-workflow-management-tool-cost.html": "自社専用業務管理システムを低コストで開発する",
    "052-pwa-web-app-vs-native-cost-comparison.html": "PWA（Webアプリ）構築でアプリ開発費を削減する",
    "053-line-api-chatbot-customer-support-cost.html": "LINE公式×ChatGPT API連携構築費用と自動顧客対応",
    "054-filemaker-access-legacy-modernization.html": "FileMaker・AccessのWebシステム移行費用とメリット",
    "055-web-scraping-automation-marketing-leads.html": "Webデータ自動収集・スクレイピング開発費用と活用術",
    "056-non-it-smb-system-development-no-engineer.html": "システム外注で失敗しない防衛策がわかる",
    "057-hiring-vs-outsourcing-cost-comparison.html": "採用固定費を回避し開発外注でコストを抑える",
    "058-excel-to-web-system-dx-cost.html": "エクセル業務限界を安価な独自Webシステムで解消",
    "059-non-it-smb-genai-business-efficiency.html": "API連携で日常の定型業務を生成AIで自動化する",
    "060-smb-system-development-cost-standard.html": "適正価格を見極め見積もりの過剰上乗せを防ぐ",
